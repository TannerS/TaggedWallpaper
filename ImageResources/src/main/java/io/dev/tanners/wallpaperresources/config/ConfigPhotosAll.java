...
public class ConfigPhotosAll extends ConfigBase {
    ...
    public static final String GET_PHOTO_METHOD = "photos";
    public static final String QUERY_ORDER_KEY = "order_by";
    public static final String QUERY_ORDER_VALUE = Order.LATEST.toString();

...
public class ConfigBase {
    ...
    public static final String HEADER_AUTH_VALUE = "<KEY HERE>";
    ...
    public static final String HEADER_PER_PAGE_VALUE = "20";

    public static final String HEADER_TOTAL_RESULTS_KEY = "X-Total";
    public static final String HEADER_TOTAL_RESULTS_VALUE = "500";
    ...
    public static final String QUERY_TOTAL_RESULTS_VALUE = "500";
}
